...
setup(name='docassemble.CriminalCourtFeeWaiver',
      ...
      install_requires=['docassemble.ALToolbox @ git+https://github.com/SuffolkLITLab/docassemble-ALToolbox.git@main', 'docassemble.AssemblyLine @ git+https://github.com/SuffolkLITLab/docassemble-AssemblyLine.git@main', 'docassemble.ILAO>=1.1.10', 'docassemble.InterviewStats @ git+https://github.com/SuffolkLITLab/docassemble-InterviewStats.git@main', 'docassemble.PovertyScale>=2024.0.0'],
      zip_safe=False,
