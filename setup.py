...
setup(name='docassemble.CriminalCourtFeeWaiver',
      ...
      install_requires=['docassemble.ALToolbox>=0.11.1', 'docassemble.AssemblyLine>=3.2.0', 'docassemble.ILAO>=1.0.99', 'docassemble.InterviewStats>=0.5.0', 'docassemble.PovertyScale>=2024.0.0'],
      zip_safe=False,
